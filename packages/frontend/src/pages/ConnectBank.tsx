    ...
    <div className="min-h-[calc(100vh-200px)] relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div className="rounded-3xl shadow-2xl overflow-hidden mb-6">
            {/* Área Principal com Botão - Gradiente claro/escuro */}
            <div className="relative bg-gradient-to-br from-blue-50 via-indigo-50 to-primary-100 dark:from-slate-800 dark:via-slate-900 dark:to-primary-900 p-8 sm:p-10">
              ...
              <div className="relative text-center">
                ...
                <p className="text-gray-600 dark:text-slate-300 mb-6 max-w-sm mx-auto leading-relaxed text-sm sm:text-base">
            ...
            <div className="bg-slate-50 dark:bg-slate-800 px-4 sm:px-6 py-5">
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="flex flex-col items-center text-center p-2">
                  <div className="w-9 h-9 bg-green-500 rounded-xl flex items-center justify-center mb-2 shadow-md">
                    <Lock className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-xs text-slate-600 dark:text-slate-300 font-medium leading-tight">Criptografia<br />de ponta a ponta</span>
                </div>
                <div className="flex flex-col items-center text-center p-2">
                  <div className="w-9 h-9 bg-blue-500 rounded-xl flex items-center justify-center mb-2 shadow-md">
                    <Shield className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-xs text-slate-600 dark:text-slate-300 font-medium leading-tight">Credenciais<br />nunca armazenadas</span>
                </div>
                <div className="flex flex-col items-center text-center p-2">
                  <div className="w-9 h-9 bg-purple-500 rounded-xl flex items-center justify-center mb-2 shadow-md">
                    <CheckCircle className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-xs text-slate-600 dark:text-slate-300 font-medium leading-tight">Acesso<br />somente leitura</span>
                </div>
                <div className="flex flex-col items-center text-center p-2">
                  <div className="w-9 h-9 bg-amber-500 rounded-xl flex items-center justify-center mb-2 shadow-md">
                    <RefreshCw className="w-4 h-4 text-white" />
                  </div>
                  <span className="text-xs text-slate-600 dark:text-slate-300 font-medium leading-tight">Revogue<br />a qualquer momento</span>
                </div>
              </div>
            </div>
          </div>
